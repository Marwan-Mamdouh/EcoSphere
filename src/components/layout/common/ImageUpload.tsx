  ...
  return (
    <div
      className={`relative group shrink-0 ${
        variant === "circle" ? "w-48 h-48" : "w-full h-full"
      } ${className}`}
    >
      <div
        className={`w-full h-full overflow-hidden border-4 border-background shadow-xl relative bg-muted ${
