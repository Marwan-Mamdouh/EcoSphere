...
export default function EventsHistory({ events }: EventProps) {
    ...
    const pastEvents = events
        ...
        .sort(
            (a, b) =>
                getEventStartDateTime(b).getTime() - getEventStartDateTime(a).getTime()
        );
    React.useEffect(() => {
    ...
    return (
        <div className="min-h-screen py-8 w-[85%] mx-auto flex flex-col gap-6">
            ...
            {/* Past Events */}
            {isLoading ? (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 py-5 gap-6 items-stretch">
                {Array.from({ length: 6 }).map((_, index) => (
                    ...
                    <div className="flex items-center justify-center md:p-20 p-5 bg-primary/10 rounded-xl mt-10 my-10">
                        <div className="text-center max-w-md px-6">
                            ...
                            <p className="text-secondary-foreground mb-4">{t("nohistory")}</p>
